...
parser.add_argument(
    "-o", "--output", 
    help="File path for saving the generated Excel file", 
    type=str, 
    required=False #CHANGE TO TRUE WHEN SUBMITTING
)
...
# OUTPUT WRITTEN TO EXCEL FILE
# WRITE THE CODE
print("Output is written to Excel file 'Test_Output.xlsx'")